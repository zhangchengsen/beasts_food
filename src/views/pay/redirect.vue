      ...
      <div class="pay-result" v-if="order">
        ...
        <div class="btn">
          <nmButton
            ...
            >查看订单</nmButton
          >
          <nmButton @click="$router.push('/')" type="gray">进入首页</nmButton>
        </div>
        <p class="alert">
...
<script>
import { ref } from "vue";
import { findOrderDetail } from "@/api/pay";
import { useRoute } from "vue-router";
export default {
  name: "nmPayResultPage",
  setup() {
