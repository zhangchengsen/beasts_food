  ...
  <div class="xtx-pay-page">
    <div class="container">
      <nmBread>
        ...
        <nmBreadItem>支付订单</nmBreadItem>
      </nmBread>
      <!-- 付款信息 -->
      <transition>
        <div class="pay-info" v-if="order.id">
      ...
      <nmDialog title="正在支付..." v-model:visible="visibleDialog">
        <div class="pay-wait">
...
import { usePayTime } from "@/hook/index";
...
const { resume, pause, timeText } = usePayTime(600);
